  ...
  <header>
    ...
    <div class="container bouton">
        <div class="py-5 text-left">
            ...
            <h2>Supprimer evenement</h2>
            <p class="lead">Suivez les instructions ci-dessus pour supprimer un evenement. N'oubliez pas de vérifier si vous avez bien complété les champs obligatoires.</p>
        </div>
        <div class="row">
            <div class="col-md-8 order-md-1">
                <!--formulaire pour supprimer un evenement-->
                <form method="post" action="scriptDelEvent.php" class="needs-validation was-validated" novalidate="">
...
?>
                    ...
                    <hr class="mb-4">
                    <input class="btn btn-primary btn-lg btn-block" type="submit" value="Supprimer">
                </form>
            </div>
        </div>
    </div>
